...
namespace BLL_Clinica.Catalogos
{
    public class cls_Empleados_BLL
    {
        ...
        public void listar_filtrar_Empleados(ref cls_Empleados_DAL Obj_EMPLEADOS_DAL)
        {
            ...
            {
                Obj_BD_DAL.sNomSp = ConfigurationManager.AppSettings["filtrar_personas"].ToString();
                Obj_BD_BLL.crearDTparametros(ref Obj_BD_DAL);
                Obj_BD_DAL.obj_dtParametros.Rows.Add("@Filtro", "7", Obj_EMPLEADOS_DAL.sID_Persona);
            }
        ...
        public void cargaempleados(ref cls_Empleados_DAL DAL_EMPL_METOD) {

            Obj_BD_DAL.sNomSp = ConfigurationManager.AppSettings["test"].ToString();
            Obj_BD_BLL.crearDTparametros(ref Obj_BD_DAL);
            Obj_BD_DAL.obj_dtParametros.Rows.Add("@Filtro", "7", DAL_EMPL_METOD.sID_Persona);
            Obj_BD_DAL.sNomTabla = "T_test";
            Obj_BD_BLL.ExecDataAdapter(ref Obj_BD_DAL);
