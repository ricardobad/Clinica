...
namespace DAL
{
    public class cls_Padecimiento_DAL
    {
        ...
        private string _sMsjError, _sDescripcion, _sPadecimientosTotales;
        ...
        public string sPadecimientosTotales { get => _sPadecimientosTotales; set => _sPadecimientosTotales = value; }
    }
}
